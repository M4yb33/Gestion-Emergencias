            ...
            <div className="flex-1 flex flex-col">
                ...
                <div className="px-5 space-y-3 flex-1">
                    ...
                    <button
                        ...
                        className={`w-full border-2 rounded-xl py-3 text-sm font-medium cursor-pointer transition-all font-sans flex items-center justify-center gap-2 ${confirmed ? "border-success bg-success/10 text-success" : "border-info bg-blue-50 text-info hover:bg-blue-100"
                            }`}
                    >
